    ...
    <div className="max-w-[1100px] mx-auto px-3 sm:px-4 md:px-8 py-10 sm:py-14 md:py-20">
      ...
      <section className="mb-10 sm:mb-12 md:mb-16">
        ...
        <ol className="list-decimal pl-6 space-y-3 text-[16px] sm:text-[18px] md:text-[20px]">
          <li>
            Read the quick start to learn the basics. <a className="text-orange hover:text-orange-light font-bold" href={Constants.DOCS_QUICKSTART_URL} target="_blank" rel="noreferrer">Quick Start</a>
          </li>
          <li>
            Explore React Server Components and Server Functions in the docs. <a className="text-orange hover:text-orange-light font-bold" href={Constants.DOCS_URL} target="_blank" rel="noreferrer">Docs</a>
          </li>
          <li>
            Join the community to ask questions and share what you’re building: {" "}
            <a className="text-orange hover:text-orange-light font-bold" href={Constants.DISCORD_URL} target="_blank" rel="noreferrer">Discord</a>{" "}
            • {" "}
            <a className="text-orange hover:text-orange-light font-bold" href={Constants.DISCOURSE_URL} target="_blank" rel="noreferrer">Forum</a>
          </li>
        </ol>
        <div className="mt-6">
      ...
      <section className="mb-10 sm:mb-12 md:mb-16">
        ...
        <p className="mb-4">If this project helps you, please give us a star on GitHub:</p>
        {/* Server Component */}
        ...
        <div className="space-y-3 text-[16px] sm:text-[18px] md:text-[20px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="bg-black p-2 border-2 border-orange-light inline-flex items-center gap-2">
              <code className="text-orange-light text-[14px] sm:text-[16px]">rwsdk.com</code>
      ...
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-black p-4 rounded-lg font-mono text-[16px] sm:text-[18px] md:text-[20px] flex items-center gap-2">
            ...
            <span className="text-orange-light"><Copy text="pnpm release" /></span>
          </div>
          <p>
            Need more detail? Read the Cloudflare guide: {" "}
            <a className="text-orange hover:text-orange-light font-bold" href={Constants.CLOUDFLARE_DOCS_URL} target="_blank" rel="noreferrer">Deploy RedwoodSDK on Cloudflare</a>
          </p>
        </div>
      </section>
    </div>
