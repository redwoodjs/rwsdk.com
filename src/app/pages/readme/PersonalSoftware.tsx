            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 overflow-y-auto px-6 md:pr-16 py-8 space-y-12">
                    <section className="space-y-6">
                        <h1 className="font-jersey-charted text-[40px] md:text-[70px] leading-[107%] tracking-normal antialiased">
                        ...
                        <p className="text-base md:text-md font-light leading-relaxed">
                    ...
                    <section className="space-y-6">
                        ...
                        <p className="text-base md:text-md leading-relaxed font-light">
