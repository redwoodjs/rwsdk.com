...
export default async function BlogList() {
  ...
  return (
    <div className="min-h-screen bg-baige">
      ...
      <meta
        name="description"
        content="Latest articles and tutorials about RedwoodSDK, Cloudflare development, and modern web technologies."
      />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-20 py-12 sm:py-16 lg:py-20">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-playfair text-black mb-4 text-center lg:text-left">
          RedwoodSDK Blog
        </h1>
        <p className="text-xl text-gray-600 text-center lg:text-left">
          Latest articles and tutorials about RedwoodSDK, The React Framework
          for Cloudflare.
        </p>
      </div>
