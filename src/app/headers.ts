...
export const setCommonHeaders =
  ...
  ({ headers, rw: { nonce }, request }) => {
    ...
    headers.set(
      ...
      "script-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://static.cloudflareinsights.com https://kwesforms.com https://scripts.simpleanalyticscdn.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://api.github.com https://kwesforms.com https://kwesforms.com/api/foreign/forms/* https://simpleanalyticscdn.com https://queue.simpleanalyticscdn.com; frame-src https://ghbtns.com https://www.youtube.com https://youtube.com https://www.youtube.com/; object-src 'none'; img-src 'self' data: https: https://queue.simpleanalyticscdn.com;"
    );
  };
