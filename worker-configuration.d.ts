// Generated by Wrangler by running `wrangler types` (hash: f888e65a5e3614355137a1e5e99592ec)
...
declare namespace Cloudflare {
	interface Env {
		...
		routes: [{"pattern":"rwsdk.com","custom_domain":true},{"pattern":"www.rwsdk.com","custom_domain":true}];
		VITE_GA_ID: string;
		ASSETS: Fetcher;
	}
}
