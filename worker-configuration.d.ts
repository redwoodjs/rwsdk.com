/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcbc963620277d45453f728c28fb7434)
// Runtime types generated with workerd@1.20251118.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ActivitySyncedStateServer";
	}
	interface Env {
		KV_ADDON_CHANGELOG: KVNamespace;
		SYNCED_STATE_KV: KVNamespace;
		APP_NAME: "redwoodsdk-staging" | "redwoodsdk-production";
		SYNCED_STATE: DurableObjectNamespace<import("./src/worker").ActivitySyncedStateServer>;
		R2: R2Bucket;
		ASSETS: Fetcher;
	}
}
